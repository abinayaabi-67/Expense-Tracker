...
dateLabel=Label(root,text="Date",font=('arial',15,'bold'),bg="cyan",fg="black",width=12)
...
Name=StringVar()
nameLabel=Label(root, text="Name",font=('arial',15,'bold'),bg="cyan",fg="black",width=12)
...
Title=StringVar()
titleLabel=Label(root, text="Title",font=('arial',15,'bold'),bg="cyan",fg="black",width=12)
...
Expense=IntVar()
expenseLabel=Label(root,text="Expense",font=('arial',15,'bold'),bg="cyan",fg="black",width=12)
...
submitbtn=Button(root,command=submitexpense,text="Submit",font=('arial',15,'bold'),bg="green",fg="black",width=12 )
submitbtn.grid(row=4,column=0,padx=13,pady=13)

viewtn=Button(root,command=viewexpense,text="View expenses",font=('arial',15,'bold'),bg="red",fg="black",width=12 )
